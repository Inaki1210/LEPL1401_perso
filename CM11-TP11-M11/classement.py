from OrderedLinkedList import OrderedLinkedList #type: ignore
...
class Classement :
    ...
    def __init__(self):
        ...
        """
        self.__resultats = OrderedLinkedList()   # dictionnaire de résultats actuelle (clé = coureur; valeur = résultat)
    ...
    def add(self,r):
        ...
        if self.size() >= self.__maxcapacity :
            raise Error("Capacity of classement exceeded") #type: ignore
        else :
            self.__size += 1
    ...
    def get_position(self,c):
        ...
        """
        return self.__resultats.getPosition(c)
