class Duree :
    ...
    def ajouter(self,d):
        ...
        """
        sec_tot = self.to_secondes() + d.to_secondes()
        self.heure = (sec_tot //3600)
        self.minute = ((sec_tot%3600)//60)
        self.seconde = ((sec_tot%3600)%60)
        rst = Duree(self.heure,self.minute,self.seconde)
        return rst
