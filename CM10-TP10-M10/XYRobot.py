...
class XYRobot :
    ...
    def turn_right(self) :
        ...
        """
        self.__turn(1)
        self.__list.append(("Turn right", self.__turn(1)))
    ...
    def turn_left(self) :
        ...
        """
        self.__turn(-1)
        self.__list.append(("Turn left", self.__turn(-1)))
    ...
    def unplay(self):
        for i in range(len(self.__list)):
            ...
            if self.__list[element][0] == "Move forward":
                XYRobot.move_backward(self.__list[element][1])
            if self.__list[element][0] == "Move backward":
                XYRobot.move_forward(self.__list[element][1])
